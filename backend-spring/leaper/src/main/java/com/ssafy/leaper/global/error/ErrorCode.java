...
public enum ErrorCode {
  ...
  /* 4. INFLUENCER – 인플루언서 */
  DUPLICATE_NICKNAME(HttpStatus.CONFLICT, "INFLUENCER-001"),
  DUPLICATE_SOCIAL_ACCOUNT(HttpStatus.CONFLICT, "INFLUENCER-002"),
  INFLUENCER_NOT_FOUND(HttpStatus.NOT_FOUND, "INFLUENCER-003");
